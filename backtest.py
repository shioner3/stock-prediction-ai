...
# 🔥 最適化対象
TAKE_PROFIT_LIST = [0.07, 0.10, 0.15]
WEIGHT_CAP_LIST = [0.4, 0.6, 0.8]
...
# バックテスト関数
# =========================
def run_backtest(take_profit, weight_cap):
...
for tp, wc in product(TAKE_PROFIT_LIST, WEIGHT_CAP_LIST):

    print(f"Running: TP={tp}, WC={wc}")

    res = run_backtest(tp, wc)
